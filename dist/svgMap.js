...
svgMap.prototype.applyData = function (data) {
  ...
  Object.keys(this.countries).forEach(function (countryID) {
    ...
    var d = fetch("https://ncov.dxy.cn/ncovh5/view/pneumonia?scene=2&clicktime=1579582238&enterid=1579582238&from=singlemessage&isappinstalled=0").then(
        successResponse => {
    ...
    data.values[countryID][data.applyData] = 0;
    data.values[countryID][data.viewData] = 0;
    data.values[countryID][data.view2Data] = 0;
